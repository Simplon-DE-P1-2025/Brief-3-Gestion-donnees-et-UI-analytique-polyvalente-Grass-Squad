...
def get_geographic_kpis(_engine: Engine, where_sql: str = "1=1", params: dict = None) -> pd.Series:
    """
...
@st.cache_data(ttl=300)
def get_map_coordinates(_engine: Engine, where_sql: str = "1=1", params: dict = None, limit: int = 3000) -> pd.DataFrame:
    """
...
@st.cache_data(ttl=300)
def get_top_zones_cross(_engine: Engine, where_sql: str = "1=1", params: dict = None, limit: int = 15) -> pd.DataFrame:
    """
